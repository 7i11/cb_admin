            ...
            compile: function (element) {
                ...
                return function (scope, element, attrs) {
                    ...
                    if (!element.hasClass('ng-table')) {
                        scope.templates = {
                            header: (attrs.templateHeader ? attrs.templateHeader : '/static/libs/angular/modules/ng-table/src/ng-table/header.html'),
                            pagination: (attrs.templatePagination ? attrs.templatePagination : '/static/libs/angular/modules/ng-table/src/ng-table/pager.html')
                        };
